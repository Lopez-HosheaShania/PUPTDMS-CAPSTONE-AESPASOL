                                        ...
                                        <tr class="tbl-row academic-item {{ $period->is_active ? 'is-active' : '' }} border-b border-gray-50 last:border-0"
                                            ...
                                            <td class="py-3 px-4">
                                                <div class="ap-actions">
                                                    <button type="button" class="ap-action-btn ap-action-edit"
                                                        title="Edit"
                                                    ...
                                                    @else
                                                        <span class="ap-action-btn ap-action-pinned"
                                                            title="Active period"><i class="fa-solid fa-star"
    ...
    <div id="filterModal" class="filter-drawer-wrapper academic-filter-modal">
        ...
        <div class="filter-drawer-panel flex flex-col bg-white">
            <div
                ...
                <button id="closeFilterModalBtn" type="button"
                    class="text-gray-400 hover:text-gray-700 transition-colors" onclick="closeAcademicFilterModal()">
    ...
    <div class="ui-modal modal-overlay ap-add-modal" id="addModal" onclick="closeModalOutside(event,'addModal')">
        <div class="modal-box modal-box-inner ap-academic-modal ap-academic-modal-lg">
            <form method="POST" action="{{ route('admin.academic_periods.store') }}" class="ap-add-form"
                data-discard-form data-discard-title="Discard new academic period?"
                            ...
                            <div>
                                ...
                                <div class="ap-input-wrap">
                                    ...
                                    <input name="start_date" type="text"
                                        ...
                                        required readonly min="1900-01-01" max="9999-12-31">
                                </div>
                                <span class="field-error hidden text-xs font-semibold text-red-500 mt-1.5"></span>
                            </div>
                        ...
                        <div style="display: flex; align-items: flex-start; gap: 0.75rem;">
                            <div class="ap-input-wrap" id="editAcademicYearWrap" style="flex: 1;">
                                ...
                                <input type="text" name="academic_year" id="editYear"
                                    class="ap-input field-input no-voice" placeholder="e.g. 2026-2027" required>
                            </div>
                            <div class="ap-voice-toggle" style="margin-top: 0; position: relative;">
