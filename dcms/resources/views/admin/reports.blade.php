...
<main id="mainContent" class="px-4 sm:px-6 pt-[82px] pb-8 min-h-screen">
    <div class="max-w-[1280px] mx-auto">
        ...
        <div class="alert-warning">
            ...
            <span>
                <strong>{{ $inventory['low_stock_count'] }} {{ Str::plural('item', $inventory['low_stock_count'])
                    }}</strong>
                ...
                <table class="inv-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($item['in_stock'] <= 0) <span class="status-pill pill-critical">Out of Stock</span>
                                    @elseif($item['in_stock'] < $item['min_level']) <span
                                        class="status-pill pill-{{ $item['in_stock'] < $item['min_level'] * 0.5 ? 'critical' : 'low' }}">
                                        {{ $item['in_stock'] < $item['min_level'] * 0.5 ? 'Critical Level'
                                            : 'Below Minimum Level' }} </span>
                                            @else
