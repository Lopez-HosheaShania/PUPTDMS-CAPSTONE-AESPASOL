...
<script>
    const STATUS_THEME = {
        today: { badge: 'status-blue', accent: 'accent-blue' },
        scheduled_today: { badge: 'status-blue', accent: 'accent-blue' },
        upcoming: { badge: 'status-orange', accent: 'accent-orange' },
        rescheduled: { badge: 'status-yellow', accent: 'accent-yellow' },
        cancelled: { badge: 'status-red', accent: 'accent-red' },
        completed: { badge: 'status-green', accent: 'accent-green' },
        default: { badge: 'status-gray', accent: 'accent-gray' }
    };
