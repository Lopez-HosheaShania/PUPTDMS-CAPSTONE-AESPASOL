                ...
                <div class="appointment-controls-bar">
                                ...
                                <div class="appointment-status-grid">
                                    @foreach ($statusOptions as $value => $meta)
                                        <button type="button"
                                            ...
                                            <span
                                                class="appointment-status-option-count">{{ $statusCounts[$value] ?? 0 }}</span>
                                        </button>
                                    @endforeach
                                </div>
                            </div>
                    ...
                    <div class="appointment-controls-actions">
                        <div class="view-toggle-container hidden md:flex">
                            ...
                            <button id="btnGridView" onclick="switchView('grid')" class="btn-view-mode"
                                title="Grid View">
                ...
                @forelse($upcomingGrouped as $month => $items)
                    <div class="appt-month-group mb-10 sm:mb-14">
                        ...
                        <div class="desktop-appointments-table relative pl-10">
                            ...
                            <div class="appt-table-head grid gap-4 text-[10px] font-bold uppercase tracking-[0.14em] text-gray-500 py-3 px-5 bg-[#FAFAFA] border border-gray-200 rounded-t-2xl mb-3"
                                style="grid-template-columns: 140px 110px 170px minmax(180px,1.15fr) 90px 115px 170px;"
                                <div class="flex items-center gap-1.5"><i
                                        class="fa-regular fa-calendar text-[10px]"></i>Date</div>
                            ...
                            <div class="space-y-2.5">
                                @foreach ($items as $i => $appt)
                                    ...
                                    <div class="appt-card {{ $isToday ? 'is-today' : '' }}"
                                        data-appt-id="{{ $appt->id }}" data-patient="{{ strtolower($patientName) }}"
                                        data-service="{{ strtolower($serviceLabel) }}"
                                        data-patient-id="{{ strtolower((string) ($appt->patient_id ?? '')) }}"
                                        data-status="{{ strtolower($appt->status ?? 'upcoming') }}"
                                        ...
                                        <div class="rounded-[14px] grid gap-4 items-center px-5 py-3.5"
                                            ...
                                            <div class="appt-patient-cell flex items-center justify-start gap-3">
                                                ...
                                                <div class="text-left min-w-0">
                                                    <p
                                                        class="appt-patient-name text-[13px] font-bold text-gray-800 leading-tight">
                                                        {{ $patientName }}</p>
                        ...
                        <div class="mobile-appointments-list">
                            @foreach ($items as $i => $appt)
                                ...
                                <div class="mobile-appt-card {{ $isToday ? 'is-today' : '' }}"
                                    ...
                                    <div
                                        class="bg-gray-50 rounded-xl p-3 mb-4 grid grid-cols-2 gap-3 border border-gray-100 ml-1">
                                        <div>
                ...
                @forelse($pastGrouped as $month => $items)
                    <div class="appt-month-group mb-10 sm:mb-14">
                        ...
                        <div class="desktop-appointments-table relative pl-10">
                            ...
                            <div class="appt-table-head grid gap-4 text-[10px] font-bold uppercase tracking-[0.14em] text-gray-400 py-3 px-5 bg-[#FAFAFA] border border-gray-200 rounded-t-2xl mb-3"
                                ...
                                @foreach ($items as $i => $appt)
                                    ...
                                    <div class="appt-card opacity-70" data-patient="{{ strtolower($patientName) }}"
                                        ...
                                        <div class="grid gap-4 items-center px-5 py-3.5"
                                            ...
                                            <div><span class="time-chip text-gray-400"><i
                                                        class="fa-regular fa-clock text-xs"></i>{{ $timeLabel }}</span>
                                            </div>
                                            ...
                                            <div class="appt-program-cell text-left">
                                                ...
                                                @else
                                                    <span
                                                        class="inline-block bg-gray-100 text-gray-400 text-[11px] font-medium px-2.5 py-1 rounded-full border border-gray-200">{{ $program }}</span>
                                                @endif
                                            </div>
                                            ...
                                            <div class="appt-status-cell text-left">
                                                <span class="status-pill {{ $pastStatusClass }} past-status-pill"
                                                    ...
                                                    data-status-base="{{ $pastStatusBase }}"
                                                    data-cancel-reason="{{ $cancelReasonLabel }}"><span
                                                        class="status-dot"></span><span
                                                        class="past-status-text">{{ $pastStatusLabel }}</span></span>
                                            </div>

                                            <div class="appt-actions-wrap">
                                                <button type="button" class="action-btn action-btn-record"
                        ...
                        <div class="mobile-appointments-list">
                            @foreach ($items as $i => $appt)
                                ...
                                <div class="mobile-appt-card opacity-75 border-gray-200"
                                    ...
                                    <div class="pl-1">
                                        <div class="flex items-start justify-between gap-2 mb-3">
                                            <div class="min-w-0">
                                                <p class="past-grid-name text-[14px] font-extrabold text-gray-500"
                                                    title="{{ $patientName }}">{{ $patientName }}</p>
                                                <p class="text-[11px] font-medium text-gray-400 mt-0.5">
                                                    {{ $weekday }},
                                                    {{ $dateLabel }}</p>
                                            </div>
                                            <span
                                                class="status-pill {{ $pastStatusClass }} past-status-pill flex-shrink-0"
                                                data-appt-id="{{ $appt->id }}"
                                                data-status-base="{{ $pastStatusBase }}"
                                                data-cancel-reason="{{ $cancelReasonLabel }}"><span
                                                    class="status-dot"></span><span
                                        ...
                                        <div
                                            class="bg-gray-50 rounded-xl p-2.5 grid grid-cols-2 gap-2 border border-gray-100 mb-3">
                                            <span
            ...
            <div class="start-procedure-body">
                <div class="start-procedure-alert">
                    ...
                    <div>
                        ...
                        <p class="start-procedure-alert-sub">You will be redirected to the odontogram page for the selected
                            patient.</p>
                    </div>
                </div>
