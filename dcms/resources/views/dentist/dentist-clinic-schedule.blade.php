...
<main id="mainContent"
    class="dentist-page-shell clinic-schedule-page dentist-clinic-schedule-page page-enter mode-list">
    <div class="w-full">
        ...
        <section class="dentist-hero cs-dentist-hero mb-5">
            <div class="dentist-hero-content">
                ...
                <div class="min-w-0">
                    ...
                    <h1 class="dentist-hero-title">Clinic Schedule</h1>
                </div>
            </div>
                                            ...
                                            <td data-label="Actions">
                                                <div class="cs-action-group">
                                                    ...
                                                    <button type="button" class="cs-action-btn cs-action-delete"
                                                        ...
                                                        onclick='openScheduleDeleteModal(@json(route("dentist.dentist.clinic_schedule.destroy", $rule)), @json($rule->days_label))'>
                        ...
                        <div class="p-4">
                            ...
                            <div id="blockedDatesListView" class="blocked-dates-view">
                                ...
                                <div
                                    ...
                                    <form action="{{ route('dentist.dentist.clinic_schedule.unblock', $blocked) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
...
<div id="ruleModalBackdrop" class="ui-modal cs-modal cs-rule-modal">
    <div class="ui-modal-card cs-modal-card cs-rule-modal-card" onclick="event.stopPropagation()">
        ...
        <div class="modal-body modal-form-body">
            <form id="ruleForm" method="POST" action="{{ route('dentist.dentist.clinic_schedule.store') }}">
                @csrf
...
<div id="blockModalBackdrop" class="ui-modal cs-modal cs-block-modal">
    <div class="ui-modal-card cs-modal-card cs-block-modal-card" onclick="event.stopPropagation()">
        ...
        <div class="modal-body modal-form-body">
            <form action="{{ route('dentist.dentist.clinic_schedule.block') }}" method="POST"
...
<script>
    ...
    function openRuleModal(mode = 'create', ruleId = null, rule = null) {
        ...
        form.action = '{{ route('dentist.dentist.clinic_schedule.store') }}';
        ...
        if (mode === 'edit' && rule) {
            ...
            form.action = `/dentist/clinic-schedule/rules/${ruleId}`;
